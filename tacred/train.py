...
parser.add_argument('--var_temp', action='store_true')
parser.add_argument('--temp_decay', type=int, default=1)
parser.add_argument('--init_temp', type=float, default=256)
parser.add_argument('--end_temp', type=float, default=8)
...
parser.add_argument('--pretrained_model', default='best_model.pt')
...
for epoch in range(1, opt['num_epoch']+1):
    ...
    dev_p, dev_r, dev_f1, mistake = scorer.score(dev_batch.gold(), predictions)
    ...
    elif dev_f1 < max(dev_f1_history):
        bad_count += 1
    ...
    if epoch % opt['temp_decay'] == 0 and opt['var_temp']:
        model.update_temp(opt['end_temp'])
